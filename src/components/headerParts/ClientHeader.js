            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <Link to='/order' className='border-indigo-500 text-gray-900 inline-flex items-center px-1 py-1 text-sm font-medium hover:text-indigo-500'>
                    Order
                  </Link>
                  <Link to='/reservation' className='border-indigo-500 text-gray-900 inline-flex items-center px-1 py-1 text-sm font-medium hover:text-indigo-500'>
                    Reservation
                  </Link>
                </div>
              </div>
